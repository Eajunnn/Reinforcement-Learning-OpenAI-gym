...
# Testing params
PRETRAINED_PATH         = "model/Eajun/DDQN2/CURRICULUM/20241208-130335/episode_400.weights.h5"
...
class RandomizedCarRacingCurriculum(gym.Wrapper):
    ...
    def apply_friction(self, brake_action):
        ...
        min_friction, max_friction = self.get_dynamic_range(0.05, 1, "friction")
    ...
    def apply_wind(self, steering_action):
        ...
        min_wind, max_wind = self.get_dynamic_range(-0.4, 0.4, "wind")
...
class DDQN_Agent:
    ...
    def save( self, name, data ):
        ...
        # plotting results
        if PLOT_RESULTS: plot_rewards( f"{REWARD_DIR}" + name + ".csv", noise_type="Curriculum" )
