...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        if done:
            ...
            plot_rewards(episode_rewards, noise_type="Curriculum")  # Plot rewards instead of durations
            break
# After the training loop
print('Training Complete')
plot_rewards(episode_rewards, show_result=True, noise_type="Curriculum", save_path="training_rewards_noiseType.png")
save_model(policy_net, noise_type="Curriculum", save_dir="models/", file_name="DDQN_cartpole_noiseType.h5")
plt.ioff()
plt.show()
